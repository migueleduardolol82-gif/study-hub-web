      ...
      <main className="workspace">
        ...
        {tab === "dashboard" && (
          <div className="home-app">
            ...
            <HomeMetricWidgetBoard widgets={metricWidgets} onChange={setMetricWidgets} values={metricValues} themeAccent={accent} />
        ...
        {tab === "today" && <RoutineWorkspace state={routine} onChange={setRoutine} tracks={skillTracks} onTracksChange={setSkillTracks} archetypes={availableArchetypes} skills={<AscensionIndex tracks={skillTracks} onChange={setSkillTracks} journeys={journeys} xp={totalXp} />} legacy={<TodayWorkspace journeys={journeys} setJourneys={setJourneys} />} />}
