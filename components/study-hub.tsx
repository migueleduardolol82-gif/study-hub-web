...
const AvatarWorkspace = dynamic(() => import("@/components/avatar-workspace"), { loading: WorkspaceSkeleton });
...
const viewLabels: Record<Tab, string> = {
  avatar: "Avatar", dashboard: "Início", study: "Estudar", mentor: "Mentor", profile: "Perfil", today: "Rotina", journeys: "Jornadas",
  ...
  useEffect(() => {
    ...
    const timeout = window.setTimeout(async () => {
      try {
        ...
        setCloudStatus("error");
        setNotice(error instanceof Error ? `${error.message} Confira o armazenamento local e não feche a página até conseguir salvar.` : "Falha ao salvar na nuvem. Não feche a página até confirmar o salvamento.");
      }
    }, 1200);
